...
import NullableRow from "./nullable-row";
  ...
  render() {
    ...
    return (
      <div>
        ...
        <NullableRow
          value={data.nullable}
          onChange={(value) => this.changeOtherValue(value, "nullable", data)}
        />
  ...
  return (
    <div>
      ...
      <NullableRow
        value={data.nullable}
        onChange={(value) =>
          changeOtherValue(value, "nullable", data, context.changeCustomValue)
        }
      />
    </div>
  );
